...
Astro Runtime now uses Python 3.10 by default. To continue using Python 3.9, see [Python versioning](runtime-version-lifecycle-policy.md#astro-runtime-airflow-and-python-version-mapping).
