...
- Use a [supported](runtime-version-lifecycle-policy.md#lifecycle-schedule) (preferably latest patch) version of [Astro Runtime](runtime-overview.md), to take advantage of the most recent security features and fixes.
